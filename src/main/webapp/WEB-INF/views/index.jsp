				...
				<div style="width: 50%; height: 70vh; overflow: scroll; overflow-x: hidden">
						<ul>
							<c:forEach items="${roomList}" var="item" varStatus="status">
								<li>
									<div class="roomProduct" style="background: white; color: black; cursor: pointer;" data-order="${status.index}" data-latitude="${item.latitude}" data-longitude="${item.longitude}" data-loc="${item.loc }" data-filename="${item.images[0].filename}">
